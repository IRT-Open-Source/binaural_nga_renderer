"""Copy of ear/cmdline/render_file.py

Nothing in here should be considered a stable part of the EAR interface.
"""
...
from ear.core.metadata_processing import preprocess_rendering_items, convert_objects_to_cartesian, convert_objects_to_polar
...
import warnings
from ear.fileio.adm.exceptions import AdmUnknownAttribute
